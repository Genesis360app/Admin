        ...
        <div className="profile-info-500 md:flex md:text-start text-center flex-1 max-w-[516px] md:space-y-0 space-y-4">
          <div className="flex-1">
            <div className="text-base text-slate-900 dark:text-slate-300 font-medium mb-1">
              <center>{naira.format(income)}</center>
            </div>
          ...
          <div className="inline-block min-w-full align-middle">
                  ...
                  <React.Fragment key={item.sub_info?.id}>
                    <tbody className="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                      <tr>
                        ...
                        <td className="table-td py-2">
                          {" "}
                          {naira.format(item.sub_info?.price || "0")}
                        </td>
                        <td className="table-td py-2">
                          {" "}
            ...
            ${
             ...
             `}
                        ...
                        <td className="table-td py-2">
                          {" "}
                          {formattedDate(item.sub_info?.due_date)}{" "}
                        </td>
                        <td className="table-td py-2">
                          {" "}
                          {formattedDate(item.sub_info?.created_at)}{" "}
                        </td>
                        <td className="table-td py-2">
                          <div>
                            <Dropdown
                            ...
                            >
                              <div className="divide-y divide-slate-100 dark:divide-slate-800">
                                ...
                                <Menu.Item
                                  onClick={() =>
                                    handleDenyStatus("denied", item.sub_info.id)
                                  }
                                  disabled={isLoading}
                                >
                                  <div
