...
const totalSales = async () => {
    try {
      ...
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_BASE_URL}/order/get/totalsales`,
        {
...
const totalOderCount = async () => {
    try {
      ...
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_BASE_URL}/order/get/count`,
        {
...
const totalProduct = async () => {
    try {
      ...
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_BASE_URL}/product/get/count`,
        {
